...
export function InterventionInput({ taskId, workerIds }: Props) {
    ...
    <div className="border-t border-gray-200 bg-white p-3">
      <div className="flex items-end gap-2">
        ...
        <textarea
          ...
          rows={1}
          placeholder="Send intervention message to agent..."
          className="flex-1 px-3 py-2 border border-gray-300 rounded-lg text-sm resize-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 min-h-[38px] max-h-[120px]"
          style={{
            height: 'auto',
